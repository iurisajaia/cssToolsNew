        ...
        return (
            <Layout {...this.props}>
                <div className="m-4">
                    ...
                    <p>Last updated: March 05, 2020</p>
                    ...
                    <ul>
                        ...
                        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to css tool.</li>
                        ...
                        <li><strong>Website</strong> refers to css tool, accessible from http://www.css-tool.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                    </ul>
                    ...
                    <ul>
                        <li>By email: support@css-info.com</li>
                        <li>By visiting this page on our website: http://www.css-tool.com/contact</li>
                    </ul>
                </div>
            </Layout>
        )
